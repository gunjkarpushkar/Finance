  ...
  return (
    <>
      ...
      <div className="description">
        <p>
          Money Tree is designed to provide personalized financial advice through
          AI and machine learning technologies. It analyzes your financial
          data—such as expenses, income, and savings—to offer tailored
          ...
          sensitive data is handled with the utmost care, making personal finance
          management accessible, insightful, and secure.
        </p>
      </div>
    </>
  );
